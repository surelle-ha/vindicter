  ...
  <div class="flex flex-col min-h-screen">
    <main class="flex-1">
      ...
      <section class="relative flex flex-col items-center justify-center pt-40 pb-24 px-6 overflow-hidden">
        <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_30%,rgba(139,92,246,0.10),transparent_60%)] pointer-events-none" />
        ...
        <div class="relative z-10 flex flex-col items-center text-center max-w-3xl">
          ...
          <p class="text-[13px] sm:text-[15px] font-semibold uppercase tracking-[0.4em] text-white/35 mb-6">
            Security Intelligence Model · by Vindicta
          </p>

          <p class="text-[15px] sm:text-[17px] leading-relaxed text-white/55 max-w-xl mb-10">
            A dedicated AI model built from the ground up for security engineering — deep vulnerability analysis, real exploit intelligence, and working code fixes, all running locally inside Vindicta.
          </p>
      ...
      <section class="border-t border-white/5 px-6 py-20 text-center">
        ...
        <h2 class="text-[36px] font-display font-black uppercase leading-tight mb-4">
          DefendCore is coming to Vindicta.
        </h2>
        <p class="text-[14px] text-white/40 max-w-md mx-auto mb-8 leading-relaxed">
          Download Vindicta now and DefendCore will be available as an AI provider the moment it launches — no reinstall, no separate account.
        </p>
        <NuxtLink
          to="/standard-beta"
