...
useHead({ title: 'Special Beta Program — Vindicta' })
...
async function submit() {
  ...
  try {
    ...
    apiError.value = 'Something went wrong. Please try again or contact support@vindicta.surelle.xyz.'
  } finally {
    loading.value = false
  }
}
      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="text-center mb-12">
          ...
          <p class="text-[15px] leading-relaxed text-white/50 max-w-xl mx-auto mb-6">
            Reserved for organisations that want early, hands-on access to Vindicta with dedicated developer support and direct input into the product roadmap.
          </p>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 mb-12">
          ...
          >
            ...
            <p class="text-[11px] text-white/40 leading-relaxed mb-4">For organisations that want to actively shape Vindicta's direction and be publicly recognised.</p>
        ...
        <div class="rounded-2xl border border-white/8 bg-surface/40 p-6 mb-10">
          ...
          <div class="prose-policy space-y-4 text-[13px] text-white/50 leading-relaxed">
            <p><strong class="text-white/70">1. Confidentiality.</strong> All pre-release builds, feature previews, and communications received through the Special Beta Programme are confidential. You agree not to publicly disclose, review, or benchmark pre-release versions without prior written consent from Vindicta.</p>
            <p><strong class="text-white/70">2. Authorised use only.</strong> Vindicta may only be used on systems, codebases, and networks your organisation owns or has explicit written authorisation to test. The programme does not grant permission to test third-party systems.</p>
            ...
            <p><strong class="text-white/70">6. No warranty.</strong> Pre-release software is provided as-is. Vindicta accepts no liability for issues arising from use of beta builds in production environments.</p>
            <p><strong class="text-white/70">7. Termination.</strong> Either party may withdraw from the programme at any time with 7 days' written notice. Vindicta reserves the right to revoke access immediately in case of terms violations.</p>
          </div>
        </div>
          ...
          <div class="space-y-5">
            ...
            <div>
              <label class="block text-[11px] font-semibold uppercase tracking-wider text-white/40 mb-2">
                How did you hear about Vindicta? <span class="normal-case font-normal text-white/25">(optional)</span>
              </label>
              <input
                v-model="referral"
                type="text"
            ...
            <label class="flex items-start gap-3 cursor-pointer group">
              ...
              <span class="text-[12px] text-white/50 leading-relaxed">
                I have read and agree to the Special Beta Programme terms above. I confirm that my organisation will use Vindicta only on systems we own or are authorised to test.
              </span>
            </label>
        ...
        <div v-else class="rounded-2xl border border-ok/20 bg-ok/5 p-8 sm:p-12 text-center">
          ...
          <p class="text-[14px] text-white/50 leading-relaxed max-w-sm mx-auto mb-6">
            Thank you for applying to the Vindicta Special Beta Programme. We'll review your application and reach out to <strong class="text-white/75">{{ contactEmail }}</strong> within 3–5 business days.
          </p>
