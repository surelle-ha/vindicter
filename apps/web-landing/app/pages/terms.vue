...
<template>
  <div class="flex flex-1 flex-col">
    <!-- Content -->
    <main class="flex-1 pt-28 pb-24 px-6">
      <div class="max-w-3xl mx-auto">

        <!-- Header -->
        <div class="mb-12">
          <p class="text-[11px] font-semibold uppercase tracking-[0.3em] text-accent/70 mb-3">Legal</p>
          <h1 class="font-display text-[44px] sm:text-[56px] font-black uppercase leading-none tracking-wide mb-4">
            Terms of Service
          </h1>
          <p class="text-[13px] text-white/35">Last updated: {{ lastUpdated }}</p>
        </div>

        <!-- Summary callout -->
        <div class="mb-10 rounded-2xl border border-accent/20 bg-accent/5 p-6">
          <div class="flex items-start gap-4">
            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-accent/15 border border-accent/20">
            ...
            <div>
              ...
              <p class="text-[13px] leading-relaxed text-white/55">
                Vindicter is free proprietary software. Use it responsibly — only on systems you own or have explicit written permission to test. We provide no warranty.
              </p>
            </div>
          </div>
        </div>
        ...
        <!-- Body -->
        <div class="prose-policy space-y-10">

          <section>
            <h2>1. Acceptance</h2>
            <p>
              By downloading, installing, or using Vindicter ("the Software"), you agree to these Terms of Service. If you do not agree, do not use the Software.
            </p>
          </section>
          ...
          <section>
            ...
            <p>Vindicter is a security research and learning tool. You agree to use it only in ways that are legal and ethical:</p>
            <ul>
              <li>Only scan, audit, or perform penetration testing on systems, networks, and codebases you own or have <strong>explicit written authorisation</strong> to test</li>
              <li>Do not use the Software to gain unauthorised access to any computer system or network</li>
              <li>Do not use the Software to violate any applicable local, national, or international law</li>
              <li>Do not use the Software for malicious purposes, including but not limited to extortion, sabotage, or data theft</li>
            </ul>
            <p>
              Unauthorised security testing is illegal in most jurisdictions. You are solely responsible for ensuring your use of Vindicter complies with all applicable laws and regulations.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Security scan results, findings, and recommendations produced by Vindicter are generated by AI and may be incomplete, inaccurate, or incorrect. Do not rely solely on Vindicter output for production security decisions. Always verify findings manually or with a qualified security professional.
            </p>
          </section>
