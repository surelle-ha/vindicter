...
<template>
  <div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <p class="mt-1 text-[13px]" style="color:rgba(255,255,255,0.40);">Here's what's happening with Vindicter.</p>
    </div>
      ...
      <div class="rounded-2xl p-5" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);">
        <div class="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p class="text-[10px]" style="color:rgba(255,255,255,0.30);">Vindicter changelog</p>
          </div>
        </div>
        <p class="text-[12px] leading-relaxed" style="color:rgba(255,255,255,0.40);">
          Stay up to date with new features, improvements, and security notes from the Vindicter team.
        </p>
