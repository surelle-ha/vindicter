...
useLandingSeo({
  title: 'Register - Vindicter',
  description: 'Create a Vindicter account for the dashboard.',
  path: '/auth/register',
})
...
async function register() {
  ...
  try {
    ...
    if (typeof localStorage !== 'undefined') localStorage.setItem('auth-token', res.access_token)
