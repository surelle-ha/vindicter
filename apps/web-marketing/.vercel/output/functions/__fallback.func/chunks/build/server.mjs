import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, isRef, toValue, toRaw, useSSRContext, isShallow, isReactive } from 'vue';
import { m as parseURL, e as encodePath, n as decodePath, o as hasProtocol, q as isScriptProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, r as getContext, $ as $fetch, v as defu, h as createError$1, x as executeAsync, y as hash } from '../_/nitro.mjs';
...
const unhead_Wlmd28S2Q_kfhPXc9QqgXoKnolzk8Mpn_TLR_gH2BnU = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./login-DKTG2M1R.mjs')
  },
  {
    name: "audiences",
    path: "/audiences",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./audiences-Cr-RTUoT.mjs')
  },
  {
    name: "campaigns",
    path: "/campaigns",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./campaigns-DwbNHn1_.mjs')
  },
  {
    name: "history",
    path: "/history",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./history-CP9n3PWr.mjs')
  },
  {
    name: "templates",
    path: "/templates",
    meta: __nuxt_page_meta || {},
    component: () => import('./templates-BRP8SeFE.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DkfbgBJU.mjs')
  }
];
...
const revive_payload_server_Qq1hqu9my_11crDB7acf6MapUkR2jAOpOcQ6kMGIlyA = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  payloadPlugin,
  unhead_Wlmd28S2Q_kfhPXc9QqgXoKnolzk8Mpn_TLR_gH2BnU,
  plugin$1,
  revive_payload_server_Qq1hqu9my_11crDB7acf6MapUkR2jAOpOcQ6kMGIlyA,
  plugin,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8
];
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-zsMfu1i6.mjs').then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import('./dashboard-C7tSto8Y.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CxW_EEzW.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DzAkwdq0.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@4.4.5_@babel+core@7.29_c196ebd1b55522946096d7120bf3ce99/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@4.4.5_@babel+core@7.29_c196ebd1b55522946096d7120bf3ce99/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useRouter as a, useRuntimeConfig as b, useNuxtApp as c, __nuxt_component_0$1 as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, useRoute as u };
